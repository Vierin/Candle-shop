...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"App\": () => (/* binding */ App)\n/* harmony export */ });\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n/* harmony import */ var gsap_dist_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! gsap/dist/ScrollTrigger.min.js */ \"./node_modules/gsap/dist/ScrollTrigger.min.js\");\n/* harmony import */ var gsap_dist_ScrollSmoother_min_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! gsap/dist/ScrollSmoother.min.js */ \"./node_modules/gsap/dist/ScrollSmoother.min.js\");\n/* harmony import */ var _components_Menu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Menu.js */ \"./src/js/components/Menu.js\");\n/* harmony import */ var _components_Slider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Slider.js */ \"./src/js/components/Slider.js\");\n/* harmony import */ var _components_Gallery_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Gallery.js */ \"./src/js/components/Gallery.js\");\n\n\n\n\n\n\n\n\ngsap__WEBPACK_IMPORTED_MODULE_3__.gsap.registerPlugin(gsap_dist_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_4__.ScrollTrigger, gsap_dist_ScrollSmoother_min_js__WEBPACK_IMPORTED_MODULE_5__.ScrollSmoother);\nclass App {\n    constructor() {\n        this.load();\n\n        if(document.querySelector('.swiper')) {\n            const heroSlider = new _components_Slider_js__WEBPACK_IMPORTED_MODULE_1__.Slider(document.querySelector('.swiper'))\n        }\n        if(document.querySelector('[data-component=\"Gallery\"]')) {\n            const gallery = new _components_Gallery_js__WEBPACK_IMPORTED_MODULE_2__.Gallery(document.querySelector('[data-component=\"Gallery\"]'));\n        }\n        \n        // smooth scroll\n       \n        let smoother = gsap_dist_ScrollSmoother_min_js__WEBPACK_IMPORTED_MODULE_5__.ScrollSmoother.create({\n            smooth: 2,   // seconds it takes to \"catch up\" to native scroll position\n            effects: true // look for data-speed and data-lag attributes on elements and animate accordingly\n          });\n\n        const menu = new _components_Menu_js__WEBPACK_IMPORTED_MODULE_0__.Menu(document.querySelector('[data-component=\"Menu\"]'));\n\n        // sort\n        const sort = document.querySelector('.sort-btn')\n        sort && sort.addEventListener('click', (e) => {\n            e.target.parentElement.classList.toggle('is-sort-open');\n        })\n\n        // search\n        document.querySelector('.js-search').addEventListener('click', () => {\n            document.documentElement.classList.toggle('is-search');\n        })\n\n        document.querySelector('.search-panel__close').addEventListener('click', () => {\n            document.documentElement.classList.remove('is-search');\n        })\n\n        if(window.ontouchstart === undefined) {\n            document.querySelector('html').classList.add('mod_no-touchevents');\n        }\n\n        // cart\n        document.querySelector('.cart-btn').addEventListener('click', (e) => {\n            e.preventDefault();\n            document.documentElement.classList.add('is-cart-open');\n        })\n\n        document.querySelector('.cart__close').addEventListener('click', () => {\n            document.documentElement.classList.remove('is-cart-open');\n        })\n\n        // header sticky \n        const header = document.querySelector('.header');\n\n        gsap_dist_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_4__.ScrollTrigger.create({\n            trigger: header,\n            start: 'top top',\n            endTrigger: 'footer',\n            end: 'bottom+=100vh bottom',\n            pin: true,\n            // pinType: \"fixed\",\n            markers: false,\n            pinReparent: true,\n            pinSpacing: false,\n            onToggle: e => {\n                header.classList.toggle('is-white')\n            }\n        });\n\n        // acc\n        document.querySelectorAll('[aria-expanded]').forEach(el => {\n            const wrap = el.nextElementSibling;\n            const height = wrap.children[0].clientHeight;\n\n            el.getAttribute('aria-expanded') == 'true' && gsap__WEBPACK_IMPORTED_MODULE_3__.gsap.set(wrap, {height: 0});\n           \n            el.addEventListener('click', () => {\n                \n\n                if(el.getAttribute('aria-expanded') == 'false') {\n                    gsap__WEBPACK_IMPORTED_MODULE_3__.gsap.to(wrap, {height: 0, duration: 0.5});\n                    el.ariaExpanded = true;\n                } else {\n                    gsap__WEBPACK_IMPORTED_MODULE_3__.gsap.to(wrap, {height, duration: 0.5});\n                    el.ariaExpanded = false;\n                }\n            })\n        })\n    }\n\n    load() {\n        // const loader = new Loader();\n\n        // window.addEventListener('load', () => {\n\n\n        //     document.body.classList.remove('is-loading');\n        //     this.setComponents();\n        //     new Animations();\n\n        //     this.curtain()\n\n        //     if(window.ontouchstart === undefined) {\n        //         document.querySelector('html').classList.add('mod_no-touchevents');\n        //     }\n        // });\n\n    }\n\n\n    // curtain() {\n\n    //     document.querySelectorAll('a[href]').forEach(link => {\n    //         link.addEventListener('click', (e) => {\n    //             e.preventDefault();\n\n    //             const href = e.currentTarget.getAttribute('href');\n    //             gsap.fromTo(document.querySelector('.js-main-curtain'), {yPercent: -100}, {yPercent: 0, duration: .4, onComplete: () => {\n    //                 window.location = href;\n    //             }})\n    //         })\n    //     });\n    // }\n\n    setComponents() {\n        // getBrowser();\n        // checkBreakpoint();\n\n        //components\n        // new SwiperSlider();\n    }\n\n}\n\n\nconst app = new App();\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");
